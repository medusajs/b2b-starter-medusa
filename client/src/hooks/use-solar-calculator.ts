...
import type {
    ...
    UseSolarKitsOptions,
    UseSolarKitsReturn,
} from 'src/types/solar-calculator';
import { solarCalculatorClient } from 'src/lib/solar-calculator-client';
// import { usePostHog } from '@/providers/posthog-provider'; // TODO: adapt for client
...
export function useSolarCalculator(
    ...
    // const { trackSolarCalculation } = usePostHog(); // TODO
    ...
    const calculate = useCallback(
        async (input: SolarCalculationInput) => {
            try {
                ...
                // trackSolarCalculation(input, true); // TODO
            } catch (err) {
                ...
                // trackSolarCalculation(input, false, error.message); // TODO
            } finally {
                setLoading(false);
            }
        },
