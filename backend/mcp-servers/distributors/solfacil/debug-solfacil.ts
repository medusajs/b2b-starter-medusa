/**
 * Debug script for Solfácil Portal
 * Maps HTML structure and selectors
 * Usage: EMAIL=user@example.com PASSWORD=password npx tsx debug-solfacil.ts
 */
...
async function debug(): Promise<void> {
  ...
  try {
    ...
    console.log('🔍 Opening Solfácil login page...');
    await page.goto('https://www.solfacil.com.br/login', { waitUntil: 'networkidle' });
    ...
    if (url.includes('/login') || url.includes('/signin')) {
      ...
      await page.goto('https://www.solfacil.com.br/produtos', { waitUntil: 'networkidle' });
