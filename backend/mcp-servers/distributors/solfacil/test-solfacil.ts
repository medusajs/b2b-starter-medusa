/**
 * Test suite for Solfácil agent
 * Usage: EMAIL=user@example.com PASSWORD=password npx tsx test-solfacil.ts
 */
...
async function runTests(): Promise<void> {
  ...
  try {
    ...
    assert(session.distributor === 'solfacil', 'Distributor name mismatch');
    ...
    assert(result.distributor === 'solfacil', 'Result distributor mismatch');
