/**
 * Test suite for Edeltec agent
 * Usage: EMAIL=user@example.com PASSWORD=password npx tsx test-edeltec.ts
 */
...
async function runTests(): Promise<void> {
  ...
  try {
    ...
    assert(session.distributor === 'edeltec', 'Distributor name mismatch');
    ...
    assert(result.distributor === 'edeltec', 'Result distributor mismatch');
