/**
 * Debug script for Edeltec Portal
 * Maps HTML structure and selectors
 * Usage: EMAIL=user@example.com PASSWORD=password npx tsx debug-edeltec.ts
 */
...
async function debug(): Promise<void> {
  ...
  try {
    ...
    console.log('🔍 Opening Edeltec login page...');
    await page.goto('https://www.edeltec.com.br/login', { waitUntil: 'networkidle' });
    ...
    if (url.includes('/login') || url.includes('/signin')) {
      ...
      await page.goto('https://www.edeltec.com.br/produtos', { waitUntil: 'networkidle' });
