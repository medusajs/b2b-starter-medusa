/**
 * Test suite for Dynamis agent
 * Usage: EMAIL=user@example.com PASSWORD=password npx tsx test-dynamis.ts
 */
...
async function runTests(): Promise<void> {
  ...
  try {
    ...
    assert(session.distributor === 'dynamis', 'Distributor name mismatch');
    ...
    assert(result.distributor === 'dynamis', 'Result distributor mismatch');
