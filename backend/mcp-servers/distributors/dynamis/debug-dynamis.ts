/**
 * Debug script for Dynamis Portal
 * Maps HTML structure and selectors
 * Usage: EMAIL=user@example.com PASSWORD=password npx tsx debug-dynamis.ts
 */
...
async function debug(): Promise<void> {
  ...
  try {
    ...
    console.log('🔍 Opening Dynamis login page...');
    await page.goto('https://www.dynamis.com.br/login', { waitUntil: 'networkidle' });
    ...
    if (url.includes('/login') || url.includes('/signin')) {
      ...
      await page.goto('https://www.dynamis.com.br/produtos', { waitUntil: 'networkidle' });
