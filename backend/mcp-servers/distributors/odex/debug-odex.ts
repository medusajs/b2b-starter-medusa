/**
 * Debug script for Odex Portal
 * Maps HTML structure and selectors
 * Usage: EMAIL=user@example.com PASSWORD=password npx tsx debug-odex.ts
 */
...
async function debug(): Promise<void> {
  ...
  try {
    ...
    console.log('🔍 Opening Odex login page...');
    await page.goto('https://www.odex.com.br/login', { waitUntil: 'networkidle' });
    ...
    if (url.includes('/login') || url.includes('/signin')) {
      ...
      await page.goto('https://www.odex.com.br/produtos', { waitUntil: 'networkidle' });
