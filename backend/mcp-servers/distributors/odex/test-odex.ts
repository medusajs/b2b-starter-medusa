/**
 * Test suite for Odex agent
 * Usage: EMAIL=user@example.com PASSWORD=password npx tsx test-odex.ts
 */
...
async function runTests(): Promise<void> {
  ...
  try {
    ...
    assert(session.distributor === 'odex', 'Distributor name mismatch');
    ...
    assert(result.distributor === 'odex', 'Result distributor mismatch');
