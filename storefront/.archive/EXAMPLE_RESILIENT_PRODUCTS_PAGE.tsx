            ...
            <div className="p-4 space-y-2">
                ...
                <div className="flex items-end justify-between">
                    ...
                    {product.availability !== undefined && (
                        <span className={`text-xs font-medium px-2 py-1 rounded ${product.availability
                ...
                <button
                    ...
                    className={`w-full py-2 px-4 rounded-md font-medium transition-colors ${fromFallback
