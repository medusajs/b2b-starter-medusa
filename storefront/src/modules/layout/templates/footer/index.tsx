            ...
            <span className="txt-small-plus txt-ui-fg-base"> Subscribe to our newsletter
              ...
              <form className='mt-4 sm:flex sm:max-w-md'>
                ...
                <input
                  ...
                  autoComplete='email'
                  required
                  className='appearance-none min-w-0 w-full bg-white border border-[#DFDEDB] rounded-md shadow-sm py-2 px-4 text-base text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:placeholder-gray-400'
