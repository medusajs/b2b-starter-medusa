  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-white to-slate-100 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-20 text-center">
        ...
        <div className="mb-12">
          <div className="inline-flex items-center gap-3 px-6 py-3 bg-white/80 backdrop-blur-md rounded-full border border-white/20 shadow-lg">
            ...
            <span className="text-xl font-bold text-gray-900">Yello Solar Hub</span>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center mb-20">
          ...
          <Link href="/store" aria-label={t("home.hero_cta_secondary")}
            ...
            <Button variant="secondary" className="border-2 border-black/20 bg-white/80 backdrop-blur-md text-gray-900 hover:bg-black hover:text-white px-10 py-5 text-lg font-semibold rounded-full transition-all duration-300 hover:scale-105 shadow-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          <div className="bg-white/60 backdrop-blur-md rounded-2xl p-6 border border-white/20 shadow-lg">
            ...
            <div className="text-sm font-semibold text-gray-900 mb-1">5 distribuidores certificados</div>
            <div className="text-xs text-gray-600">Qualidade garantida</div>
          </div>
          <div className="bg-white/60 backdrop-blur-md rounded-2xl p-6 border border-white/20 shadow-lg">
            <div className="w-3 h-3 bg-gradient-to-r from-blue-400 to-blue-600 rounded-full mx-auto mb-3"></div>
            <div className="text-sm font-semibold text-gray-900 mb-1">713 produtos disponíveis</div>
            <div className="text-xs text-gray-600">Ampla variedade</div>
          </div>
          <div className="bg-white/60 backdrop-blur-md rounded-2xl p-6 border border-white/20 shadow-lg">
            <div className="w-3 h-3 bg-gradient-to-r from-yellow-400 to-orange-500 rounded-full mx-auto mb-3"></div>
            <div className="text-sm font-semibold text-gray-900 mb-1">Garantia até 25 anos</div>
            <div className="text-xs text-gray-600">Durabilidade máxima</div>
          </div>
        </div>
      </div>
    </div>
