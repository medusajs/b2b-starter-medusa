...
.DESCRIPTION
  O script remove node_modules, limpa o cache do Yarn via Corepack e executa `yarn install --immutable`.
...
.EXAMPLE
  pwsh -File infra/scripts/windows/reset-node-modules.ps1 -WorkspacePath ../backend
#>
[CmdletBinding()]
param(
