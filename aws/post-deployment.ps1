...
if (-not $SkipECSDeploy) {
    Write-Info "`nWaiting 30 seconds for tasks to stabilize..."
...
Write-Info "Execution time: $($duration.ToString('mm\:ss'))"
